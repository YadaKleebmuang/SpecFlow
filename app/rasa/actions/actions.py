    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        intent_map = {
            "ask_cpu_info": {
                ...
                "texts": [
                    "CPU (ซีพียู) เปรียบเสมือนสมองของคอมพิวเตอร์ ทำหน้าที่ประมวลผลคำสั่งต่างๆ ยิ่งมี Core/Thread เยอะและความเร็ว (GHz) สูง ก็ยิ่งประมวลผลงานหนักๆ หรือหลายโปรแกรมพร้อมกันได้ดีครับ",
                    "CPU ทำหน้าที่ประมวลผลกลาง คล้ายกับสมองส่วนสั่งการครับ หากต้องการเปิดโปรแกรมหลายตัวพร้อมกัน หรือทำงานประมวลผลหนัก แนะนำให้เลือก CPU ที่มี Cores/Threads เยอะ เช่น Intel Core i5/i7 หรือ AMD Ryzen 5/7 ครับ",
                    "สำหรับสายเล่นเกม นอกจากการ์ดจอแล้ว ความเร็วสัญญาณนาฬิกา (Clock Speed / GHz) ของ CPU ก็สำคัญมากครับ เพราะจะช่วยให้การคำนวณเฟรมเรตในเกมมีความนิ่งและลื่นไหลไม่มีสะดุดครับ"
                ]
            },
            "ask_gpu_info": {
                "file": "card_faq_gpu.json",
                "texts": [
                    "GPU (การ์ดจอ) ทำหน้าที่ประมวลผลภาพและกราฟิกครับ ถ้าคุณเน้นเล่นเกม 3D หรือทำงานตัดต่อ/เรนเดอร์วิดีโอ การ์ดจอที่แรงจะช่วยให้ภาพลื่นไหลและทำงานเสร็จไวขึ้นมากครับ",
                    "GPU ทำงานร่วมกับ VRAM (หน่วยความจำบนการ์ดจอ) หากคุณเปิดจอความละเอียดสูง (2K/4K) หรือทำงานกราฟิกขนาดใหญ่ การเลือกการ์ดจอที่มี VRAM ขนาด 8GB ขึ้นไป จะช่วยลดปัญหาเฟรมเรตร่วงและอาการภาพโหลดช้าได้ดีครับ",
                    "ควรเลือกการ์ดจอค่ายไหนดี? การ์ดจอ NVIDIA เด่นเรื่องเทคโนโลยี Ray Tracing และ DLSS ที่ช่วยเร่งประสิทธิภาพในเกม รวมถึงมีโปรแกรมเฉพาะทางรองรับเยอะ ส่วนค่าย AMD จะเด่นเรื่องความคุ้มค่าต่อราคาและปริมาณ VRAM ที่ให้มาเยอะครับ"
                ]
            },
            "ask_ram_info": {
                "file": "card_faq_ram.json",
                "texts": [
                    "RAM (แรม) คือหน่วยความจำชั่วคราว ยิ่งมี RAM เยอะ (เช่น 16GB หรือ 32GB) คอมพิวเตอร์ก็จะสามารถเปิดหลายๆ โปรแกรมพร้อมกัน หรือเปิดแท็บเบราว์เซอร์เยอะๆ ได้โดยที่เครื่องไม่ค้างครับ",
                    "ปัจจุบันแรมมีทั้ง DDR4 และ DDR5 ครับ โดย DDR5 จะมีความเร็วบัสการรับส่งข้อมูล (Speed) ที่เร็วกว่า ประหยัดพลังงานมากกว่า แต่จะต้องใช้ร่วมกับเมนบอร์ดและ CPU รุ่นใหม่ที่รองรับเท่านั้น ไม่สามารถใส่ปนกันได้ครับ",
                    "ความจุ RAM เท่าไหร่ถึงจะพอในปัจจุบัน? ขนาด 8GB เหมาะกับการใช้งานเอกสาร/ท่องเว็บทั่วไป ขนาด 16GB เป็นมาตรฐานสำหรับการเล่นเกมยุคใหม่ ส่วนขนาด 32GB ขึ้นไป เหมาะกับสายตัดต่อกราฟิก ทำงาน 3D หรือสตรีมเกมครับ"
                ]
            },
            "ask_ssd_hdd_diff": {
                "file": "card_faq_ssd_hdd.json",
                "texts": [
                    "SSD และ HDD เป็นตัวเก็บข้อมูลทั้งคู่ครับ แต่ SSD จะเร็วกว่า HDD หลายสิบเท่า ทำให้เปิดเครื่องและโหลดเกมไวมาก ส่วน HDD จะมีราคาถูกกว่าในความจุที่เท่ากัน แนะนำให้ใช้ SSD ลงวินโดว์และโปรแกรมหลัก แล้วใช้ HDD เก็บไฟล์งานทั่วไปครับ",
                    "SSD เองก็แบ่งเป็นสองแบบหลักๆ คือ SATA (ความเร็วประมาณ 500 MB/s) และ PCIe NVMe M.2 (ความเร็วสูงถึง 3000-7000 MB/s) แนะนำให้เลือกซื้อแบบ NVMe M.2 เพื่อความเร็วในการโอนถ่ายข้อมูลที่คุ้มค่าที่สุดในปัจจุบันครับ",
                    "ความทนทานและการเก็บรักษาข้อมูล: HDD ใช้จานแม่เหล็กหมุน มีโอกาสเสียหากได้รับการกระแทกขณะทำงาน ส่วน SSD ใช้ชิปหน่วยความจำทนแรงกระแทกได้ดีกว่า แต่อายุการใช้งาน SSD จะนับตามปริมาณการเขียนข้อมูล (TBW) ครับ"
                ]
            }
        }
        ...
        if cfg:
            # Randomly select a variation index
            num_variations = len(cfg["texts"])
            selected_idx = random.randint(0, num_variations - 1)
            selected_text = cfg["texts"][selected_idx]

            if tracker.get_latest_input_channel() == "line":
                try:
                    card_payload = load_static_card(cfg["file"])
                    if isinstance(card_payload, list):
                        # Use the matched index if valid, else fallback to random choice
                        if selected_idx < len(card_payload):
                            selected_card = card_payload[selected_idx]
                        else:
                            selected_card = random.choice(card_payload)
                        dispatcher.utter_message(custom=selected_card)
                    else:
                        dispatcher.utter_message(custom=card_payload)
                except Exception as e:
                    print(f"Error loading FAQ card {cfg['file']}: {e}")
                    dispatcher.utter_message(text=selected_text)
            else:
                dispatcher.utter_message(text=selected_text)
        else:
